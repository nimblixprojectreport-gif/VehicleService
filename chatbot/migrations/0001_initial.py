    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Category name (e.g., Booking)", max_length=100
                    ),
                ),
                (
                    "description",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "answer",
                    models.TextField(help_text="The response the chatbot will give"),
                ),
                (
                    "is_active",
                    models.BooleanField(
                ...
                (
                    "order",
                    models.IntegerField(default=0, help_text="Display order in menu"),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                (
